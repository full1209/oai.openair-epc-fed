...
class mmeConfigGen():
	...
	def GenerateMMEConfigurer(self):
		...
		if not self.magma:
			...
			mme_conf_file.write('    REALM                                     = "' + self.realm + '"\n')
			mme_conf_file.write('    PID_DIRECTORY                             = "/var/run";\n')
			mme_conf_file.write('    MAXENB                                    = 8;                              # power of 2\n')
			mme_conf_file.write('    MAXUE                                     = 16;                             # power of 2\n')
			mme_conf_file.write('    RELATIVE_CAPACITY                         = 10;\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    EMERGENCY_ATTACH_SUPPORTED                     = "no";\n')
			mme_conf_file.write('    UNAUTHENTICATED_IMSI_SUPPORTED                 = "no";\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    # EPS network feature support\n')
			mme_conf_file.write('    EPS_NETWORK_FEATURE_SUPPORT_IMS_VOICE_OVER_PS_SESSION_IN_S1      = "no";    # DO NOT CHANGE\n')
			mme_conf_file.write('    EPS_NETWORK_FEATURE_SUPPORT_EMERGENCY_BEARER_SERVICES_IN_S1_MODE = "no";    # DO NOT CHANGE\n')
			mme_conf_file.write('    EPS_NETWORK_FEATURE_SUPPORT_LOCATION_SERVICES_VIA_EPC            = "no";    # DO NOT CHANGE\n')
			mme_conf_file.write('    EPS_NETWORK_FEATURE_SUPPORT_EXTENDED_SERVICE_REQUEST             = "no";    # DO NOT CHANGE\n')
			...
			mme_conf_file.write('    # Display statistics about whole system (expressed in seconds)\n')
			mme_conf_file.write('    MME_STATISTIC_TIMER                       = 10;\n')
			mme_conf_file.write('    IP_CAPABILITY = "IPV4";                                                   # UE PDN_TYPE\n')
			mme_conf_file.write('    USE_STATELESS = "";\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    INTERTASK_INTERFACE :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        # max queue size per task\n')
			mme_conf_file.write('        ITTI_QUEUE_SIZE            = 2000000;\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    S6A :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        S6A_CONF                   = "' + self.prefix + '/mme_fd.conf"; # YOUR MME freeDiameter config file path\n')
			mme_conf_file.write('        HSS_HOSTNAME               = "hss"; # relevant for freeDiameter only\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    # ------- SCTP definitions\n')
			mme_conf_file.write('    SCTP :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        # Number of streams to use in input/output\n')
			mme_conf_file.write('        SCTP_INSTREAMS  = 8;\n')
			mme_conf_file.write('        SCTP_OUTSTREAMS = 8;\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    # ------- S1AP definitions\n')
			mme_conf_file.write('    S1AP :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        # outcome drop timer value (seconds)\n')
			mme_conf_file.write('        S1AP_OUTCOME_TIMER = 10;\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    # ------- MME served GUMMEIs\n')
			mme_conf_file.write('    GUMMEI_LIST = (\n')
			mme_conf_file.write('         { MCC="' + self.mcc + '" ; MNC="' + self.mnc + '"; MME_GID="' + self.mme_gid + '" ; MME_CODE="' + self.mme_code + '"; }\n')
			mme_conf_file.write('    );\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    # ------- MME served TAIs\n')
			mme_conf_file.write('    TAI_LIST = (\n')
			for tai in tais[ 0:len(tais)-1 ]:
				tai_elmnts = tai.split(' ')
			...
			mme_conf_file.write('    );\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    TAC_LIST = (\n')
			tai = tais[0]
			tai_elmnts = tai.split(' ')
			mme_conf_file.write('         {MCC="'+tai_elmnts[1]+'" ; MNC="'+tai_elmnts[2]+ '";  TAC = "'+ tai_elmnts[0] +'"; }\n')
			mme_conf_file.write('    );\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    CSFB :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        NON_EPS_SERVICE_CONTROL = "OFF";\n')
			mme_conf_file.write('        CSFB_MCC = "' + self.mcc + '";\n')
			mme_conf_file.write('        CSFB_MNC = "' + self.mnc + '";\n')
			mme_conf_file.write('        LAC = "1";\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('    NAS :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        ORDERED_SUPPORTED_INTEGRITY_ALGORITHM_LIST = [ "EIA2" , "EIA1" , "EIA0" ];\n')
			mme_conf_file.write('        ORDERED_SUPPORTED_CIPHERING_ALGORITHM_LIST = [ "EEA0" , "EEA1" , "EEA2" ];\n')
			mme_conf_file.write('        T3402                                 =  1                              # in minutes (default is 12 minutes)\n')
			mme_conf_file.write('        T3412                                 =  54                             # in minutes (default is 54 minutes, network dependent)\n')
			mme_conf_file.write('        T3422                                 =  6                              # in seconds (default is 6s)\n')
			mme_conf_file.write('        T3450                                 =  6                              # in seconds (default is 6s)\n')
			mme_conf_file.write('        T3460                                 =  6                              # in seconds (default is 6s)\n')
			mme_conf_file.write('        T3470                                 =  6                              # in seconds (default is 6s)\n')
			mme_conf_file.write('        T3485                                 =  8                              # UNUSED in seconds (default is 8s)\n')
			mme_conf_file.write('        T3486                                 =  8                              # UNUSED in seconds (default is 8s)\n')
			mme_conf_file.write('        T3489                                 =  4                              # UNUSED in seconds (default is 4s)\n')
			mme_conf_file.write('        T3495                                 =  8                              # UNUSED in seconds (default is 8s)\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    SGS :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        TS6_1                                 =  10                             # in seconds (default is 10s)\n')
			mme_conf_file.write('        TS8                                   =  4                              # in seconds (default is 4s)\n')
			mme_conf_file.write('        TS9                                   =  2                              # in seconds (default is 4s)\n')
			mme_conf_file.write('        TS10                                   =  4                              # in seconds (default is 4s)\n')
			mme_conf_file.write('        TS13                                   =  4                              # in seconds (default is 4s)\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    NETWORK_INTERFACES :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        MME_INTERFACE_NAME_FOR_S1_MME         = "' + self.mme_s1c_name + '";\n')
			mme_conf_file.write('        MME_IPV4_ADDRESS_FOR_S1_MME           = "' + self.mme_s1c_IP + '/24";\n')
			mme_conf_file.write('        MME_INTERFACE_NAME_FOR_S11_MME        = "' + self.mme_s11_name + '";\n')
			mme_conf_file.write('        MME_IPV4_ADDRESS_FOR_S11_MME          = "' + str(self.mme_s11_IP) + '/24";\n')
			mme_conf_file.write('        MME_PORT_FOR_S11_MME                  = 2123;\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    LOGGING :\n')
			mme_conf_file.write('    {\n')
			mme_conf_file.write('        OUTPUT            = "CONSOLE";\n')
			mme_conf_file.write('        THREAD_SAFE       = "no";\n')
			mme_conf_file.write('        COLOR             = "no";\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('        SCTP_LOG_LEVEL     = "ERROR";\n')
			mme_conf_file.write('        GTPV1U_LOG_LEVEL   = "INFO";\n')
			mme_conf_file.write('        SPGW_APP_LOG_LEVEL = "INFO";\n')
			mme_conf_file.write('        UDP_LOG_LEVEL      = "INFO";\n')
			mme_conf_file.write('        S1AP_LOG_LEVEL     = "INFO";\n')
			mme_conf_file.write('        NAS_LOG_LEVEL      = "INFO";\n')
			mme_conf_file.write('        MME_APP_LOG_LEVEL  = "INFO";\n')
			mme_conf_file.write('        GTPV2C_LOG_LEVEL   = "INFO";\n')
			mme_conf_file.write('        S11_LOG_LEVEL      = "INFO";\n')
			mme_conf_file.write('        S6A_LOG_LEVEL      = "INFO";\n')
			mme_conf_file.write('        UTIL_LOG_LEVEL     = "INFO";\n')
			mme_conf_file.write('        MSC_LOG_LEVEL      = "ERROR";\n')
			mme_conf_file.write('        ITTI_LOG_LEVEL     = "ERROR";\n')
			mme_conf_file.write('        MME_SCENARIO_PLAYER_LOG_LEVEL = "ERROR";\n')
			mme_conf_file.write('        ASN1_VERBOSITY    = "INFO";\n')
			mme_conf_file.write('    };\n')
			mme_conf_file.write('\n')
			mme_conf_file.write('    S-GW :\n')
			mme_conf_file.write('   {\n')
			mme_conf_file.write('       SGW_IPV4_ADDRESS_FOR_S11              = "' + str(self.spgwc0_s11_IP) + '";\n')
			mme_conf_file.write('   };\n')
			mme_conf_file.write('};\n')
		mme_conf_file.close()
		...
		if self.fromDockerFile:
			if not self.magma:
				...
				mmeFile.write('cd /conv-mme/scripts\n')
		else:
		...
		if not self.fromDockerFile:
			...
			if self.magma:
				mmeFile.write('sed -i -e "s@etc/freeDiameter@etc@" ' + self.prefix + '/mme_fd.conf\n')
				mmeFile.write('sed -i -e "s@bind: 127.0.0.1@bind: ' + str(self.redis_IP) + '@" /etc/magma/redis.yml\n')
...
def Usage():
	...
	print('  --magma')
	print('  --redis_IP=[Redis Server IP address]')
...
while len(argvs) > 1:
	...
	elif re.match('^\-\-magma', myArgv, re.IGNORECASE):
		myMME.magma = True
	elif re.match('^\-\-redis_IP=(.+)$', myArgv, re.IGNORECASE):
		matchReg = re.match('^\-\-redis_IP=(.+)$', myArgv, re.IGNORECASE)
		myMME.redis_IP = ipaddress.ip_address(matchReg.group(1))
	else:
		Usage()
